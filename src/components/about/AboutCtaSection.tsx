...
export default function AboutCtaSection({
  ...
  return (
    <section className="mb-6 border-t border-[#B38D42]/15 bg-transparent py-10 md:mb-8 md:py-12">
      <div className="mx-auto max-w-[1250px] px-4 md:px-8">
        <div className={`mx-auto max-w-3xl ${isArabic ? 'text-right' : 'text-center'}`}>
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-[#160A0A]/70 md:text-[15px]">{description}</p>
